...
import { Table, Input, Skeleton , Popconfirm, Form, Typography, Button, message } from 'antd';
...
const CategoryList = () => {
  ...
  return (
    ...
    <Button icon ={<PlusOutlined/>} type="primary" onClick={e => navigate.push("/category/new")}>Create new category</Button>
      <Table
        components={{
          body: {
            cell: EditableCell,
        ...
        bordered
        dataSource={data?.getAllCategories.map(resItem => ({...resItem, 
